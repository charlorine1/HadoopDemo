...
//     	conf.set("yarn.resourcemanager.hostname", "cdh02");
		conf.set("hbase.zookeeper.quorum", "cdh03");
	...
	public int run(String[] args) throws Exception {
        ...
        TableMapReduceUtil.initTableMapperJob(this.initScans(job), 
        		ActiveUserMapper.class, StatsUserDimension.class, TimeOutputValue.class, job, false);
